...
import { CategoryOption, expenseCategories } from "../data/home";
      ...
      >
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View className="w-11/12 rounded-3xl bg-white overflow-hidden">
            <View className="px-4 py-4 bg-[#FFE2E2] flex-row justify-between items-center">
              <View className="flex-row items-center gap-3">
                <View className="h-10 w-10 rounded-full bg-[#FDB7B7] items-center justify-center">
                ...
                <View>
                  <Text className="text-[#B50000] font-bold text-lg">
                    Tambah Pengeluaran
                  </Text>
            ...
            <View className="p-4 gap-3">
              <View>
                ...
                <TextInput
                  ...
                  placeholder="Rp 0"
                  returnKeyType="next"
                  className="rounded-xl border border-gray-300 px-4 py-3 text-xl text-center bg-white"
                />
              </View>
              <View>
                ...
                <CategoryPicker
                  value={cat}
                  onChange={setCat}
                  options={expenseCategories as CategoryOption[]}
                  tintColor="#f00"
                />
              </View>
              <View>
                ...
                <View className="relative">
                  <TextInput
                    ...
                    returnKeyType="done"
                    className="rounded-xl border border-gray-300 px-5 py-4 bg-white pr-12"
                  />
              ...
              >
                <LinearGradient
                  colors={
                    canSave ? ["#F00", "#570000"] : ["#FECACA", "#9CA3AF"]
                  }
                  start={{ x: 0, y: 0 }}
                  end={{ x: 1, y: 8 }}
                  style={{
              ...
              <Pressable
                onPress={onClose}
                className="rounded-lg border border-gray-300 py-3 mt-2 items-center"
              >
